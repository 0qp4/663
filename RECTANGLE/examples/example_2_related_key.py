"""
Example 2: Related-Key Differential Analysis
Search for differential trail with non-zero key difference (related-key setting).
"""
import sys
...
if trails:
    trail = trails[0]
    print(f"\nOptimal related-key trail found!")
